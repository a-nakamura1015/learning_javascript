...
const arr2 = ["one", 2, "three"]; // 異なる型の要素を持つ配列
...
//console.log(arr4[0][0]); // undefined
//console.log(arr4[0][1]); // undefined
console.log(arr4[1][0]); // {name: 'キジ', type: 'object'}
//console.log(arr4[1][1]); // { name: "鬼", type: "object"}
...
　console.log(arr1); // [1, 2, 3, , 5]
  ...
  const arr7 = new Array(2) // 長さが２の配列(各要素はundefined)
